  ...
  "inline-flex items-center justify-center rounded-md border font-medium  whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-[color,box-shadow] overflow-hidden",
  {
    variants: {
      variant: {
        ...
        "primary-light":
          "border-transparent bg-primary-light text-primary-foreground [a&]:hover:bg-primary-light/90",
        "primary-dark":
        ...
        "accent-light":
          "border-transparent bg-accent text-accent-foreground [a&]:hover:bg-accent-light/90",
        "accent-dark":
          "border-transparent bg-accent text-accent-foreground [a&]:hover:bg-accent-dark/90",
        ...
        result:
          "bg-card  rounded-sm border border-border text-center normal-case",
        ...
        english:
          "border-transparent bg-english/90 text-english-foreground [a&]:hover:bg-english/90",
