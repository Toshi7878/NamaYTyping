  ...
  "inline-flex items-center cursor-pointer justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        outline:
          "border bg-transparent shadow-xs hover:bg-accent hover:text-accent-foreground border-border",
        "outline-success":
          "border border-success text-success shadow-xs hover:bg-success/50",
        "outline-destructive":
          "border border-destructive text-destructive shadow-xs hover:bg-destructive/50",
        "outline-warning":
          "border border-warning text-warning shadow-xs hover:bg-warning/50",
        "outline-info":
          "border border-info text-info shadow-xs hover:bg-info/50",
        "outline-accent":
          "border shadow-xs bg-accent text-accent-foreground hover:bg-accent/90",
...
const loadingVariants = cva(
  "text-primary-foreground animate-spin rounded-full",
  {
    variants: {
      size: {
        default: "size-6",
